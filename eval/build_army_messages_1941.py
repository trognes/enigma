...
M = [
 ...
 ("ALVPM","09.09.1941","09 Sep 1941","VAT","nostrip","ALVPM",
  ...
  "decrypt is exact regardless. GARBLES: 6 in 172 letters (3.5%) -- but SEVERAL "
  "ARE PROBABLY TRANSCRIPTION ERRORS IN THIS CIPHERTEXT, NOT 1941 GARBLES, and "
  "the ciphertext here is a transcription from the message-form image made in "
  "this repo. Three of the six need the SAME ciphertext letter (B read as T at "
  "pos 11, 140, 163); B is the rarest letter in the transcription at 2 against "
  "6.6 expected while T is over-represented at 9, and restoring those three "
  "gives B=5 T=6, both at expectation. The errors also cluster at the EDGES -- "
  "4 in transcription lines 1-2, 2 in lines 8-9, and 100 consecutive clean "
  "letters in lines 3-7, which is an image-reading pattern rather than a radio "
  "one. NOT CORRECTED HERE: editing ciphertext to make the German read better "
  "is the circular reasoning that produced the bad FTNBK transcription. Recheck "
  "against the image before changing anything. The KEY is unaffected either "
  "way -- 166 of 172 letters decrypt to clean telegraphic German and Enigma has "
  "no diffusion. The listed positions, dirtiest of the three: "
 ...
 ("ALRHG","09.09.1941","09 Sep 1941","VAT","nostrip","ALRHG",
  ...
  "(needs ciphertext G->Q, a plausible misreading, so this too may be "
  "transcription rather than a 1941 garble; same caveat as ALVPM), "
