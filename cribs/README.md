...
guessed to be present in a message*, for the crib-driven plugboard deduction
in `archived/cribs.md`. Read by `enigma --crib-list`.
...
a single rotor setting. See `archived/cribs.md` §5a.
...
cost. That model was later measured wrong (`archived/cribs.md` §12 step 6), which is why
...
than discarding the expensive ones (`archived/cribs.md` §12 step 6).
